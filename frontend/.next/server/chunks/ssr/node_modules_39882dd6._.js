...
var V1InngestExecution = class extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$components$2f$execution$2f$InngestExecution$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["InngestExecution"] {
	...
	*/ createCheckpointHandlers() {
        ...
        const syncHandlers = {
            ...
            "steps-found": async ({ steps })=>{
                if (steps.length !== 1 || steps[0].mode !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$types$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["StepMode"].Sync) return this.checkpointAndSwitchToAsync(steps.map((step)=>({
                        ...step,
                        id: step.hashedId
                    })));
            ...
            "checkpointing-runtime-reached": ()=>{
                return this.checkpointAndSwitchToAsync([
                    {
                        op: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$types$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["StepOpCode"].DiscoveryRequest,
	...
	*/ async transformOutput(dataOrError) {
    ...
    initializeCheckpointRuntimeTimer(state) {
        ...
        const maxRuntimeMs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$helpers$2f$temporal$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["isTemporalDuration"])(this.options.checkpointingConfig.maxRuntime) ? this.options.checkpointingConfig.maxRuntime.total({
            unit: "milliseconds"
        }) : typeof this.options.checkpointingConfig.maxRuntime === "string" ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ms$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"])(this.options.checkpointingConfig.maxRuntime) : this.options.checkpointingConfig.maxRuntime;
        if (!Number.isFinite(maxRuntimeMs) || maxRuntimeMs <= 0) return;
        this.checkpointingMaxRuntimeTimer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$inngest$2f$helpers$2f$promises$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createTimeoutPromise"])(maxRuntimeMs);
...
//# sourceMappingURL=node_modules_39882dd6._.js.map